...
vim.api.nvim_set_hl(0, 'Error', { fg = colors.gui00, bg = colors.gui0F })
vim.api.nvim_set_hl(0, 'ErrorMsg', { fg = colors.gui0F })
...
-- LSP highlighting
vim.api.nvim_set_hl(0, 'LspDiagnosticsDefaultError', { fg = colors.gui0F })
...
vim.api.nvim_set_hl(0, 'DiagnosticError', { fg = colors.gui0F })
